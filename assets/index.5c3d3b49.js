...
`,me=e=>{const{children:t,title:r}=e;return u(nt,{children:[r&&n(st,{children:n("h2",{children:r})}),n("main",{children:t})]})},it=l.form`
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,at=l.span`
  width: 100%;
  text-align: center;
`,pe=e=>{const y=e,{children:t,buttonText:r,buttonIsDisable:o,isLoading:s,bottomText:i,onSubmit:a}=y,d=I(y,["children","buttonText","buttonIsDisable","isLoading","bottomText","onSubmit"]);function h($){$.preventDefault(),a($)}return u(it,x(p({onSubmit:h},d),{children:[t,r&&n(pt,{type:"submit",className:"button",paddingLg:!0,disabled:o,isLoading:s,children:r}),i&&u(H,{children:[n(kt,{maxWidth:"360px",marginY:"1.5rem"}),n(at,{children:i})]})]}))},lt=c`
  &:focus {
...
`,pt=e=>{const h=e,{type:t="button",children:r,variant:o,paddingLg:s,isLoading:i,disabled:a}=h,d=I(h,["type","children","variant","paddingLg","isLoading","disabled"]);return u(ut,x(p({type:t,disabled:i||a,variant:o,paddingLg:s},d),{children:[i&&n(mt,{}),n("div",{style:{opacity:i?0:1},children:r})]}))},ht=l.input`
  ${fe}
  height: 2.5rem;
`,ft=l.div`
  display: flex;
...
`,gt=e=>{const i=e,{label:t="",htmlFor:r,children:o}=i,s=I(i,["label","htmlFor","children"]);return u(ft,x(p({},s),{children:[t&&n("label",{htmlFor:r,children:t}),o]}))},A=e=>{const h=e,{type:t="text",label:r="",focused:o=!1,autoComplete:s="off"}=h,i=I(h,["type","label","focused","autoComplete"]),a=m.exports.useRef(null),d=m.exports.useMemo(()=>Le(),[]);return m.exports.useEffect(()=>{var y;o&&((y=a.current)==null||y.focus())},[]),n(gt,{htmlFor:d,label:r,children:n(ht,p({ref:a,type:t,autoComplete:s,id:d},i))})},go=l.textarea`
  ${fe}
  resize: none;
...
`,kt=e=>{const{width:t,maxWidth:r,marginY:o}=e;return n(bt,{width:t,maxWidth:r,marginY:o,children:u("div",{className:"content",children:[n("div",{className:"square"}),n("span",{className:"line left"}),n("span",{className:"line right"})]})})};function yt(e,t){const[r,o]=m.exports.useState(()=>{const s=localStorage.getItem(e);return s?JSON.parse(s):t});return m.exports.useEffect(()=>{localStorage.setItem(e,JSON.stringify(r))},[e,r]),[r,o]}function Y(e=500){return new Promise(t=>setTimeout(t,e))}const M={spacing:{xs:"0.5rem",sm:"1rem",md:"1.5rem",lg:"3rem",xl:"5rem"},fontSize:{xs:".75rem",sm:"1rem",md:"1.5rem",lg:"2rem",xl:"2.5rem"},fontFamily:{primary:"'Roboto', sans-serif",secondary:"'Inter', sans-serif",mono:"'Roboto Mono', monospace"},colors:{highlight:"#FF8484",blue:"#2374ab",green:"#73d75d",purple:"#5b2a86",gray:"#5c5c5c",yellow:"#f6e75c",red:"#ff5757",lightGray:"#f5f5f5"}},wt=x(p({},M),{title:"light",colors:x(p({},M.colors),{primary:"#FF8484",secondary:"#FFFBEB",background:"#f5f5f5",text:"#333"})}),vt=x(p({},M),{title:"dark",colors:x(p({},M.colors),{primary:"#333",secondary:"#FFFBEB",background:"#222",text:"#f5f5f5"})}),ge=m.exports.createContext({}),$t=({children:e})=>{const[t,r]=yt("theme","light");function o(){r(t==="light"?"dark":"light")}const s=m.exports.useMemo(()=>t==="light"?wt:vt,[t]);return n(ge.Provider,{value:{theme:s,toggleTheme:o},children:n(Fe,{theme:p({},s),children:e})})};function xe(){const e=m.exports.useContext(ge);return p({},e)}const It=l.button`
  position: fixed;
  z-index: 10;
  top: 10px;
  right: 5px;
...
`,zt=l.main`
  ...
  padding-bottom: 0.5rem;
  font-size: 18px;
`,Et=(e,t)=>{const{title:r="Empty title",maxWidth:o=500,onClose:s,children:i}=e,[a,d]=m.exports.useState(!1);function h(v){!v&&s&&s(),d(v)}function y(v){v.stopPropagation(),h(!1)}m.exports.useImperativeHandle(t,()=>({setVisibility:h}));const $=v=>{v.key==="Escape"&&d(!1)};return m.exports.useEffect(()=>(a?window.addEventListener("keydown",$):window.removeEventListener("keydown",$),()=>{window.removeEventListener("keydown",$)}),[a]),a?u(H,{children:[n(Ct,{className:"modal-overlay",onClick:y}),u(Ft,{style:{maxWidth:`${o}px`},className:"modal",onClick:v=>v.stopPropagation(),children:[u(_t,{children:[n("h2",{className:"title",children:r}),n("button",{className:"btn-close",onClick:()=>d(!1),children:n(_e,{})})]}),n(zt,{children:i})]})]}):null};var ko=m.exports.forwardRef(Et);const V="#c3c3c3",At=c`
  &:after,
  &:before {
    content: "";
    position: absolute;
...
`;var Pt="/task-manager/assets/bg-left.077b3676.png",Ot="/task-manager/assets/bg-right.86ac34a2.png",Rt="/task-manager/assets/logo.ad5c05c1.png";const Bt=({children:e})=>u(tt,{children:[n(Lt,{}),n(ot,{src:Pt,alt:"background texture",draggable:!1}),n(rt,{src:Ot,alt:"background texture",draggable:!1}),n("div",{style:{width:"100%",display:"flex",position:"relative",zIndex:2},children:n("img",{src:Rt,alt:"logo",draggable:!1,style:{objectFit:"cover",maxWidth:"200px",margin:"1rem auto"}})}),n("main",{style:{position:"relative",zIndex:2},children:e})]}),Nt=l.div`
  display: flex;
  width: 100%;
  height: 100vh;
  overflow: hidden;
...
`,jt=()=>{const[,e]=ze(),[t]=oe("/home"),[r]=oe("/profile"),{theme:o,toggleTheme:s}=xe(),[i,a]=m.exports.useState(!1);return n(Ut,{isExpanded:i,children:n("nav",{children:u(Ht,{children:[u(z,{title:"Menu",onClick:()=>a(!i),children:[n(Ee,{}),n(E,{isExpanded:i,children:"Menu"})]}),u(z,{title:"Home",isSelected:t,onClick:()=>e("/home"),children:[n(Ae,{}),n(E,{isExpanded:i,children:"Home"})]}),u(z,{title:"Profile",isSelected:r,onClick:()=>e("/profile"),children:[n(Pe,{}),n(E,{isExpanded:i,children:"Profile"})]}),u("div",{style:{marginTop:"auto"},children:[u(z,{title:"Toggle theme",onClick:s,children:[o.title==="light"?n(le,{}):n(ae,{}),n(E,{isExpanded:i,children:"Toggle theme"})]}),u(z,{title:"Logout",onClick:()=>k.userStore.logout(),children:[n(Oe,{}),n(E,{isExpanded:i,children:"Logout"})]})]})]})})})},Dt=U`
  from {
    width:0%; 
  }
  100%{
...
`,Gt=()=>n(Wt,{}),Vt=({children:e})=>u(Nt,{children:[n(jt,{}),n("main",{children:n(m.exports.Suspense,{fallback:n(Gt,{}),children:e})})]}),qt=l.div`
  position: fixed;
  top: 0;
  left: 0;
  display: flex;
...
`,Jt=()=>n(qt,{children:n("div",{className:"loader"})}),Xt="modulepreload",ie={},Yt="/task-manager/",K=function(t,r){return!r||r.length===0?t():Promise.all(r.map(o=>{if(o=`${Yt}${o}`,o in ie)return;ie[o]=!0;const s=o.endsWith(".css"),i=s?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${i}`))return;const a=document.createElement("link");if(a.rel=s?"stylesheet":Xt,s||(a.as="script",a.crossOrigin=""),a.href=o,document.head.appendChild(a),s)return new Promise((d,h)=>{a.addEventListener("load",d),a.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${o}`)))})})).then(()=>t())};function ke(e){let t="Ops, an error occurred... try later";return e&&e.response&&e.response.data&&(typeof e.response.data=="string"?t=e.response.data:e.response.data.message&&typeof e.response.data.message=="string"&&(t=e.response.data.message)),t}const Kt=()=>{const[e,t]=m.exports.useState({email:"",password:""}),[r,o]=m.exports.useState(!1);function s(a){const{value:d,name:h}=a.target;t(y=>x(p({},y),{[h]:d}))}async function i(){try{o(!0),await k.userStore.login(e)}catch(a){const d=ke(a);de.error(d),o(!1)}}return n(J,{children:n(ue,{style:{position:"relative",zIndex:5},children:n(me,{title:"Login",children:u(pe,{onSubmit:i,isLoading:r,buttonText:"Login",bottomText:u(H,{children:["Don","'","t have account yet ? ",n(X,{to:"/register",children:"Register here."})]}),children:[n(A,{focused:!0,label:"Email",type:"email",name:"email",value:e.email,autoComplete:"on",onChange:s}),n(A,{label:"Password",type:"password",name:"password",value:e.password,onChange:s})]})})})})},Zt={name:"",email:"",password:""},Qt=()=>{const[e,t]=m.exports.useState(Zt),[r,o]=m.exports.useState(!1);function s(a){const{value:d,name:h}=a.target;t(y=>x(p({},y),{[h]:d}))}async function i(){try{o(!0),await k.userStore.register(e)}catch(a){const d=ke(a);de.error(d),o(!1)}}return n(J,{children:n(ue,{children:n(me,{title:"Register",children:u(pe,{onSubmit:i,isLoading:r,buttonText:"Register",bottomText:u(H,{children:["Already have an account ? ",n(X,{to:"/login",children:"Login here."})]}),children:[n(A,{focused:!0,label:"Name",name:"name",value:e.name,onChange:s}),n(A,{label:"Email",type:"email",name:"email",value:e.email,onChange:s}),n(A,{label:"Password",type:"password",name:"password",value:e.password,onChange:s})]})})})})},eo=()=>u(J,{style:{display:"flex",justifyContent:"center",alignItems:"center"},children:[n(et,{children:"Page not found"}),u("p",{children:["Oops, we couldn't find that page. Try going ",n(X,{to:"/home",children:"home"}),"."]}),n(Re,{size:"7rem"})]}),Z=500,to=_.lazy(async()=>(await Y(Z),K(()=>import("./index.5570a0d4.js"),["assets/index.5570a0d4.js","assets/vendor.46ded456.js","assets/index.c3fa9f86.js","assets/index.93eb378d.js"]))),oo=_.lazy(async()=>(await Y(Z),K(()=>import("./index.967ea61d.js"),["assets/index.967ea61d.js","assets/vendor.46ded456.js","assets/index.c3fa9f86.js"]))),ro=_.lazy(async()=>(await Y(Z),K(()=>import("./index.beb6a267.js"),["assets/index.beb6a267.js","assets/vendor.46ded456.js","assets/index.93eb378d.js","assets/index.c3fa9f86.js"]))),G="/task-manager/",no=G.endsWith("/")?G.slice(0,-1):G,so=()=>n(Be,{base:no,children:k.userStore.user?n(Vt,{children:u(re,{children:[n(S,{path:"/home",component:to}),n(S,{path:"/profile",component:oo}),n(S,{path:"/template/:id",children:e=>n(ro,{templateId:e.id})}),n(ne,{to:"/home"}),n(S,{component:eo})]})}):n(Bt,{children:u(re,{children:[n(S,{path:"/login",component:Kt}),n(S,{path:"/register",component:Qt}),n(ne,{to:"/login"})]})})});var io=ce(so);const ao=()=>(m.exports.useEffect(()=>{k.userStore.checkUserAuth()},[]),m.exports.useEffect(()=>{k.userStore.token&&k.templateStore.fetchTemplates(k.userStore.token)},[k.userStore.token]),k.isLoading?n(Jt,{}):n(io,{}));var lo=ce(ao),co=Ne`
  *,
  *:before,
  *:after {
    padding: 0;
...
`;const uo=({children:e})=>n($t,{children:e}),ye=_.createContext(k),mo=({children:e})=>n(ye.Provider,{value:k,children:e}),$o=()=>_.useContext(ye);Me.exports.polyfill({dragImageTranslateOverride:Ue.exports.scrollBehaviourDragImageTranslateOverride});He.render(n(_.StrictMode,{children:u(uo,{children:[n(co,{}),u(mo,{children:[n(lo,{}),n(je,{draggable:!1,autoClose:3e3,limit:3,position:"bottom-center",transition:De})]})]})}),document.getElementById("root"));export{xo as A,pt as B,bo as C,pe as F,A as I,X as L,ko as M,J as P,fo as S,w as a,g as b,et as c,gt as d,go as e,Ot as f,ke as g,yo as h,wo as i,vo as j,F as k,k as s,$o as u};
